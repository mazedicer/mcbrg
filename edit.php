...
<html>
	<head>
        <meta charset="utf-8"/>
		<title>Customtoyguns Edit</title>
		...
		<div id="content" class="container-fluid">
			<div class="row">
				<div class="page-header">
					<h1><a href="index.php">Customtoyguns</a> <small>Edit</update></h1>
				</div>
			</div>
			<div class="row">
				<div id="main_div">
					...
					<div class="login_div">
						<div class="input-group">
							...
							<span class="input-group-addon">
								<button type="button" class="btn btn-default btn-lg" onclick="Edit.logIn()">
